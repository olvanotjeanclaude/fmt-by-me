        ...
        <div class="presetantion">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <h3 class="title-slider wow slideInLeft">Tonga soa ato amin’ny pejy « fiombonan’ny malagasy eto
                        torkia ».</h3>
                            ...
                            <article class="post media-post clearfix pb-0 mb-10">
                                ...
                                <div class="post-text">
                                    ...
                                    <ul class="list-inline font-12 article-date">
                                        <li class="pr-0"><i
                                                class="fa fa-calendar"></i> {{ dateToFrench($coming_event->activity_date,"j F Y") }}
                                        </li>
                                ...
                                <article class="post media-post clearfix pb-0 mb-10 post--inline">
                                    ...
                                    <div class="post-right post-text">
                                        ...
                                        <ul class="list-inline font-14 article-date">
                                            <li class="pr-0"><i
                                                    class="fa fa-calendar"></i> {{ dateToFrench($event->activity_date,"j F Y") }}
                                            </li>
                                            <!-- <li class="pl-0" style="margin-left: 5px;"><i class="fa fa-map-marker"></i> New York</li> -->
                                        </ul>
                        ...
                        @if($assContact)
                            @if($assContact->phone)
                                <div class="widget-contact__item">
                                    <span class="widget-contact__title"><i
                                            class="fa fa-phone red"></i> Téléphone:</span>
                            ...
                            @if($assContact->address)
                                <div class="widget-contact__item">
                                    <span class="widget-contact__title"><i
                                            class="fa fa-map-marker red"></i> Adresse:</span>
